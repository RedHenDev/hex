...
document.addEventListener('DOMContentLoaded', function() {
    console.log("DOM Content Loaded - waiting for A-Frame to initialize components");
        ...
        if (AFRAME && AFRAME.components && AFRAME.components['terrain-manager']) {
            ...
            AFRAME.components['terrain-manager'].prototype.setupDebugPanel = function() {
                try {
                    ...
                    // Add our texture controls if the function exists
                    if (typeof addTextureControls === 'function') {
