// terrain-controls.js - Adds UI controls for terrain configuration
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (AFRAME.components['terrain-manager']) {
        ...
        // Replace it with our enhanced version that adds terrain config controls
        AFRAME.components['terrain-manager'].prototype.setupDebugPanel = function() {
            // Call original function first to set up basic debug panel
            originalSetupDebugPanel.call(this);
            
            // Now add our terrain configuration controls
            try {
                // Get debug panel
                ...
                // Add terrain configuration section
                addTerrainConfigControls(panel, this);
                
            } catch (error) {
                console.error('Error adding terrain config controls:', error);
            }
        };
    } else {
